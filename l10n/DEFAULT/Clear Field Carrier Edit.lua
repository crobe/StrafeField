...
if ( GameMode == 0 ) then
	...
	trigger.action.outText("Operation Clear Field Will Run In Multiplayer Mode [Aerial Starts For AI CAP and Fleet Defence]", 15)
	...
	trigger.action.outText("Operation Clear Field Will Run In Singleplayer Mode [Ground Starts For AI CAP and Fleet Defence]", 15)
